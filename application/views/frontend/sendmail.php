			...
			<tr>
				<td colspan="2">
					<p style="text-align: justify; padding: 10px;">
						Dear Customer DAMRI,<br>
						Terima kasih telah menggunakan DAMRI Ticketing.
					</p>
					<p style="text-align: justify; padding: 10px;">
							...
							<tr>
								<td colspan="2">
									<p style="padding:10px;">
										<br>
										Hormat Kami,<br>
										<span style="color:#fd7521;"><strong>DAMRI Ticketing</strong></span>
										<br>
										<br>
									</p>
								</td>
