					...
					<div class="row">
						<div class="col-lg-3  col-md-6 col-sm-6">
							<div class="single-footer-widget">
								<h4 class="text-white">DAMRI</h4>
								<p>
									.... DAMRI ADALAH ANGKUTAN NASIONAL TERBESAR DIINDONESIA ...
								</p>
							</div>
						</div>
            ...
            <p class="footer-text m-0">Copyright Andika Setyawan&copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> </p>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
